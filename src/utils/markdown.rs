...
window._mCopy=function(el){var c=el.closest('.mermaid-block').querySelector('.m-src-code').textContent;navigator.clipboard.writeText(c);var a=el.querySelector('.c-btn'),b=el.querySelector('.d-btn');a.style.display='none';b.style.display='';setTimeout(function(){a.style.display='flex';b.style.display='none'},2000)};
}
"#;
